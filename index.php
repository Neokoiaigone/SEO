    ...
    <nav class=" navbar navbar-default">
        <div class="container">
            ...
            <div class="navbar-header">
                ...
                <a class="navbar-brand animated FadeInDown" href="#">Cuda</a>
            </div>
            ...
            <div class="col-md-10 col-md-offset-1">
                <div class="text-center">
                    <h1 class="animated FadeInDown">
                        LOUIS-ALEXANDRE BRICQ !
                    </h1>
                    <a href="#" class="btn btn-warning btn-lg btn btn-6 btn-6d">PROJETS REALISES</a>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="text-center wow FadeInDown">
                    ...
                    <hr>
                    <p>Voici les savoir faires que j'ai utilisés jusqu'à maintenant à l'iim pour créer mes sites
                        internet. </p>
                </div>
            </div>
            <div class="col-md-3">
                <div class="service text-center wow FadeInLeft">
                    ...
                    <p>Forums, blogs, réseaux sociaux... les sites Web d'aujourd'hui sont fonctionnels, participatifs,
                        ils se renouvellent sans cesse. Ils sont « dynamiques ». Le langage PHP a été créé justement
                        pour générer cette interactivité. </p>
                </div>
            </div>
            <div class="col-md-3">
                <div class="service text-center wow FadeInLeft">
            ...
            <div class="col-md-3">
                <div class="service text-center wow FadeInRight">
                    ...
                    <h3>À quoi ça sert ?</h3>
                    <p>WordPress est un système de gestion de contenus permettant de créer son propre site assez
                        facilement. En plus de sa simplicité d'utilisation, il présente de nombreux autres atouts. </p>
                </div>
            </div>
            <div class="col-md-3 ">
                <div class="service text-center wow FadeInRight">
                    ...
                    <h3>À quoi ça sert ?</h3>
                    <p>Faire bouger, apparaitre ou disparaitre des éléments de la page (un titre, un menu, un
                        paragraphe, une image…).
                        Mettre à jour des éléments de la page sans recharger la page (changer le texte, recalculer un
                        nombre, etc).
                    </p>
                </div>
            </div>
    ...
    <div class="container">
        <div class="row">
            <div class=" text-center wow FadeInDown">
                ...
                <hr>
                <p>Voici une présentation de moi même et des personnes avec qui je travail souvent.</p>
            </div>
            <div class="col-md-3">
                <div class="rencontre text-center wow FadeInDown">
                    ...
                    <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut
                        labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco
                        laboris nisi ut aliquip ex ea commodo consequat. </p>
                    <a href="https://www.facebook.com/Pnlmusic/?fref=ts"><img src="images/facebook.svg" alt="fb"
                                                                              class="icone"></a>
                    <a href="https://www.facebook.com/Pnlmusic/?fref=ts"><img src="images/twitter.png" alt="twitter"
                                                                              class="icone"></a>
                    <a href="https://www.facebook.com/Pnlmusic/?fref=ts"><img src="images/mail2.png" alt="mail"
                                                                              class="icone"></a>
                    <a href="https://www.facebook.com/Pnlmusic/?fref=ts"><img src="images/insta.png" alt="insta"
                                                                              class="icone"></a>
                </div>
            </div>
            <div class="col-md-3">
            ...
            <div class="col-md-3">
                <div class="rencontre text-center wow FadeInUp">
                    <img src="images/esport.jpg" alt="Valentin-esportif"
                         class="img-responsive roundedImage center-block"/>
                    <h3>E-sportif</h3>
    ...
    <selection id="contact">
        <div class="container" id="contactus">
            <div class="row">
                <div class="col-md-10 col-md-offset-1">
                    <div class="text-center">
                        <h2 class="contact-us wow FadeInDown">
                            CONTACTEZ NOUS
                        </h2>
                        <hr>
                        <p class="adressecontact wow FadeInDown"> Lorem ipsum dolor sit amet, consectetur adipisicing
                            elit.</p>
                        <div class="contacter col-md-12 col-sm-12">
                            <div class="name col-xs-6 wow FadeInLeft">
                                <input type="text" class="form-control" placeholder="* Your Name">
                            </div>
                            <div class="email1 col-xs-6 wow FadeInRight">
                                <input type="text" class="form-control" placeholder="* Your Email">
                            </div>
                            <div class="email col-xs-12 wow FadeInLeft">
                                <textarea name="msg" row="6" placeholder="* Your message"></textarea>
                            </div>
